...
def plot_rel(*, save_name: str | None = "auto"):
    ...
    pc = ax.pcolormesh(hw_1D, T_1D, rel, shading="auto", cmap="coolwarm", vmin=-16, vmax=0)
    ...
    if save_name is not None:
        filename = "stage_1_analytic_approx_rel_error.png" if save_name == "auto" else save_name
