...
\begin{align}
\mathcal{E}_{v}(\mathbf{k})&=-\mathcal{E}_{0v} - \frac{{\hbar ^{2}k_{\perp}^{2}}}{2m_{V \perp}} - \frac{{\hbar ^{2}k_{\parallel}^{2}}}{2m_{V \parallel}} &&\implies-\mathcal{E}_{0 v}-A_{v}k_{\perp}^{2}-B_{v}k_{\parallel}^{2}  &&&(\mathcal{E}<\mathcal{E}_{0v})\\
\ \ \ \mathcal{E}_{c}(\mathbf{k})&= \ \ \mathcal{E}_{0 c} + \frac{{\hbar ^{2}k_{\perp}^{2}}}{2m_{C \perp}} - \frac{{\hbar ^{2}k_{\parallel}^{2}}}{2m_{C \parallel}} && \implies \ \ \mathcal{E}_{0 c}+A_{c}k_{\perp}^{2}-B_{c}k_{\parallel}^{2} &&&(\mathcal{E}>\mathcal{E}_{0c})
...
\subsection{1. Cylindrical Symmetry}
...
\subsection{2. Linearized Momenta}
...
\begin{equation}
\boxed{\Gamma_{e}^{\text{cv}}(\hbar\omega) =\frac{\pi^{2}|\mu|^{2}}{\hbar \sqrt{ \overline{A}D }}
