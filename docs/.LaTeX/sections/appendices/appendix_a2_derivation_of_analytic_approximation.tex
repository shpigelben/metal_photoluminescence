...
\end{equation}
The dispersion relation of the conduction band is isotropic. This allows us to move from the 3-dimensional momentum space to the 1-dimensional energy space using the Appendix~\ref{app:electronic_density_of_states}, namely
\begin{equation}
