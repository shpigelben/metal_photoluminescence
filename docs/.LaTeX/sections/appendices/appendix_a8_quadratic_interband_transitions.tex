...
\begin{equation}
\frac{\pi^{2}|\mu|^{2}}{\hbar \sqrt{ \overline{A}D }}\int\limits_{\mathcal{E}_{min}(\hbar \omega)}^{\mathcal{E}_{max}(\hbar \omega)}  \, \frac{f(\mathcal{E})\Big[ 1-f(\mathcal{E}-\Delta) \Big]}{\sqrt{ \mathcal{E}_{max}(\hbar\omega) -\mathcal{E}}} \; \delta \big( \Delta - \hbar\omega \big) \; d\Delta d\mathcal{E}
