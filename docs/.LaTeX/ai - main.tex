...
\input{ai - section_literature.tex}
\input{ai - section_background.tex}
\input{ai - section_formalism.tex}
\input{ai - section_supporting.tex}
\input{ai - section_numerical.tex}
\input{ai - section_intraband.tex}
\input{ai - section_results.tex}
\input{ai - section_detailed_intra.tex}
\input{ai - section_sensitivity.tex}
\input{ai - section_experimental.tex}
\input{ai - section_thesis_outline.tex}
\input{ai - section_interband.tex}

\appendix
\input{ai - section_appendix.tex}
