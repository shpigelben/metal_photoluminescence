...
Our material of choice for this work is gold for which an approximate dispersion relation exists for both bands [Rosei](../../../resources/5%20-%20Rosei.pdf). Those approximations hold near the X and L points in Gold's Brillouin zone which has 6 and 8 such facets respectively. So a total account of the electronic part should be
