...
Because the CEDS is **open**, the companion condition $k_\perp^{2}\ge0$ does **not** bound $E$ from below; the lower limit is set by occupation, not geometry. Rosei therefore cuts the integral at a thermal floor
