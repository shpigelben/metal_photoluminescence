You are hitting on a subtle and often "hand-waved" aspect of solid-state physics derivations. Your observation is entirely correct: **Neither the Rosei paper nor the standard texts explicitly treat the geometric transformation of the Brillouin Zone (BZ) boundaries when switching coordinates.**
...
Here is the breakdown of why this happens and what can be said about the "missing" treatment.
