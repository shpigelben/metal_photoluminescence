...
\begin{center}
  \includegraphics[width=0.25\textwidth]{new - figs/bgu_logo.png}
\end{center}
...
\input{new - section_overview.tex}
\input{new - section_literature.tex}
\input{new - section_background.tex}
\input{new - section_formalism.tex}
\input{new - section_supporting.tex}
\input{new - section_numerical.tex}
\input{new - section_intraband.tex}
\input{new - section_results.tex}
\input{new - section_detailed_intra.tex}
\input{new - section_sensitivity.tex}
\input{new - section_experimental.tex}
\input{new - section_thesis_outline.tex}
\input{new - section_interband.tex}

\appendix
\input{new - section_appendix.tex}
